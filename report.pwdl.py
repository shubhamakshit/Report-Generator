...
REPORT_GENERATOR_DB = '/data/data/com.termux/files/home/Report-Generator/database.db'
...
def process_test(test_id, test_name, test_mapping_id, args):
    ...
    try:
        ...
        for i, q in enumerate(questions):
            # (The logic for parsing questions remains the same)
            option = None
        ...
        if wrong_q_info:
            ...
            create_a4_pdf_from_images(wrong_q_info, WRONG_Q_DIR, pdf_filename, args.images_per_page)
            if args.final:
        ...
        if unattempted_q_info:
            ...
            create_a4_pdf_from_images(unattempted_q_info, UNATTEMPTED_Q_DIR, pdf_filename, args.images_per_page)
            if args.final:
                add_to_report_generator(pdf_filename, subject, all_tags, args.notes)
